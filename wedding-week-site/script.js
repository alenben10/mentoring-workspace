...
const days = [
  ...
  },
  {
    ...
    place: "Sage Chapel + The Statler Hotel",
    summary: "El centro de la semana: ceremonia al mediodía, fotos en campus y recepción en Statler.",
    motif: "alpaca",
    sticker: llamas.flower,
    hero: photos.sage,
    activities: [
      { time: "12:00-1:00", title: "Ceremonia", place: "Sage Chapel", detail: "Ceremonia de Alen & Belen en Cornell.", photo: photos.sageInterior, llama: llamas.flower },
      { time: "1:00-2:15", title: "Fotos en campus", place: "Cornell", detail: "Fotos familiares y de pareja alrededor de Sage Chapel y campus.", photo: photos.sage },
      { time: "2:30 aprox.", title: "Recepción", place: "The Statler Hotel", detail: "Inicio de recepción, almuerzo, brindis, baile y celebración.", photo: photos.familyMeal },
    ],
  },
  {
    date: "21",
    weekday: "Domingo",
    title: "BBQ y pachamanca en Robert H. Treman State Park",
    place: "Upper Shelter, Robert H. Treman",
    summary: "Cierre peruano al aire libre: reserva en Upper Shelter, comida, cataratas y bosque.",
    motif: "llama",
    sticker: llamas.eating,
    hero: photos.treman,
    activities: [
      { time: "10:00", title: "Check-in Upper Shelter", place: "Robert H. Treman", detail: "La reserva del pabellón corre de 10:00 a.m. a 9:00 p.m.; fee de $10 por vehículo al llegar.", photo: photos.treman },
      { time: "12:00", title: "BBQ + pachamanca", place: "Upper Shelter", detail: "Comida peruana para compartir después de la boda.", photo: photos.pachamanca, llama: llamas.eating },
      { time: "1:30", title: "Lowe Falls + Enfield Glen", place: "Robert H. Treman", detail: "Caminata por la zona de cataratas.", photo: photos.treman },
      { time: "3:00", title: "Baño en cataratas", place: "Lower Falls", detail: "Sólo si clima, parque y seguridad lo permiten. Check-out del pabellón: 9:00 p.m.", photo: photos.treman },
    ],
  },
  {
    date: "22",
